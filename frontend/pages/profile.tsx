...
export default function ProfilePage() {
  ...
  if (!user) {
    return <div className="p-8 text-center text-green-100">Loading profile...</div>;
  }

  return (
    <div className="min-h-screen bg-slate-950 flex items-center justify-center">
      <div className="w-full max-w-lg p-8 bg-slate-900 rounded-2xl shadow-2xl border border-green-900/30">
        <h1 className="text-3xl font-bold text-green-100 mb-2">Profile</h1>
        <p className="text-green-400 mb-6">View and manage your account information.</p>
